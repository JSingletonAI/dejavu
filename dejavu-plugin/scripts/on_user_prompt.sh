...
#
# Fires on every user message. Instead of pre-searching dejavu with the
...
USER_ID="$DEJAVU_RESOLVED_USER_ID"

cat <<EOF
## Memory check

Before responding, decide whether persistent memory context from dejavu would
