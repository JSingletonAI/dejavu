...
### Option 3: Link globally (makes `dejavu` available system-wide)
...
> **Warning:** If you also have the Python CLI installed, both register the `dejavu` command. The last one linked/installed wins. Unlink with `pnpm unlink --global`.
