...
def retrieve_context(query: str, user_id: str):
    ...
    memories = dejavu.search(query, user_id=user_id)
...
> **Dedicated skill available.** For comprehensive Vercel AI SDK documentation, see the [dejavu-vercel-ai-sdk skill](../dejavu-vercel-ai-sdk/SKILL.md) ([GitHub](https://github.com/dejavu-memory/dejavu/tree/main/skills/dejavu-vercel-ai-sdk)).
...
def search_memory(query: str, user_id: str) -> str:
    ...
    memories = dejavu.search(query, user_id=user_id, top_k=3)
...
def chatbot(state: State):
    ...
    memories = dejavu.search(messages[-1].content, user_id=user_id)
