...
- A Deja Vu Platform API key ([Get one here](https://app.dejavu.ai/dashboard/api-keys?utm_source=oss&utm_medium=skill-dejavu-quickstart))
...
# Search memories
curl -X POST https://api.dejavu.ai/v2/memories/search/ \
  -H "Authorization: Token $VENICE_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
