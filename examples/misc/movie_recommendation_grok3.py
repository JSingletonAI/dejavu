"""
Memory-Powered Movie Recommendation Assistant (Grok 3 + Deja Vu)
This script builds a personalized movie recommender that remembers your preferences
(e.g. dislikes horror, loves romcoms) using Deja Vu as a memory layer and Grok 3 for responses.

In order to run this file, you need to set up your Deja Vu API at Deja Vu platform and also need an XAI API key.
...
# Configure Deja Vu with Grok 3 and Qdrant
config = {
