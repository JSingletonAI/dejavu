...
In order to run this file, you need to set up your Deja Vu API at Deja Vu platform and also need a OpenAI API key.
...
print(
    chat_user(
        ...
        image_path="travel_items.jpeg",  # this will be added to Deja Vu memory
        user_id=user_id,
    )
)
