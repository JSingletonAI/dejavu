---
title: Delete Memory
description: Remove memories from Deja Vu either individually, in bulk, or via filters.
icon: "trash"
iconType: "solid"
---
...
Deleting memories is how you honor compliance requests, undo bad data, or clean up expired sessions. Deja Vu lets you delete a specific memory, a list of IDs, or everything that matches a filter.
...
<Callout type="tip" icon="plug">
  **MCP Alternative**: With <Link href="/platform/dejavu-mcp">Deja Vu MCP</Link>, AI agents can delete their own memories when data becomes irrelevant or at user request.
</Callout>
...
- <Link href="/cookbooks/operations/support-inbox">Support Inbox with Deja Vu</Link> demonstrates compliance-driven deletes.
