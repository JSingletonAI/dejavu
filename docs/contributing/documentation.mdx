---
title: Documentation
description: "Guide to contributing documentation to Deja Vu, including Mintlify setup, prerequisites, and local preview steps."
icon: "book"
---
...
By following these steps, you can efficiently contribute to Deja Vu's documentation.
