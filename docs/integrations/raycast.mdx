...
description: "Deja Vu Raycast extension for intelligent memory management"
---

Deja Vu is a self-improving memory layer for LLM applications, enabling personalized AI experiences that save costs and delight users. This extension lets you store and retrieve text snippets using Deja Vu's intelligent memory system. Find Deja Vu in [Raycast Store](https://www.raycast.com/dev_khant/dejavu) for using it.

## Getting Started

**Get your API Key**: You'll need a Deja Vu API key to use this extension:

a. Sign up at <a href="https://app.dejavu.ai?utm_source=oss&utm_medium=integration-raycast" rel="nofollow">app.dejavu.ai</a>
