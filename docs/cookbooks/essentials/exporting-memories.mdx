...
Deja Vu is a dynamic memory store that gives you full control over your data. Along with storing memories, it gives you the ability to retrieve, export, and migrate your data whenever you need.
...
<Note>
Your API key needs export permissions to download memory data. Check your project settings on the <a href="https://app.dejavu.ai?utm_source=oss&utm_medium=cookbook-exporting-memories" rel="nofollow">dashboard</a> if export operations fail with authentication errors.
</Note>
...
Guide how Deja Vu resolves conflicts or formats the export:
...
You can also export memories directly from the Deja Vu platform UI:
