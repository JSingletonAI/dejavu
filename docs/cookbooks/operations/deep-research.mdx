...
Deep Research is an intelligent agent that synthesizes large amounts of online data and completes complex research tasks, customized to your unique preferences and insights. Built on Deja Vu's technology, it enhances AI-driven online exploration with personalized memories.

You can check out the GitHub repository here: [Personalized Deep Research](https://github.com/dejavu-memory/personalized-deep-research/tree/dejavu)

## Overview

Deep Research leverages Deja Vu's memory capabilities to:
...
- [Personalized Deep Research GitHub](https://github.com/dejavu-memory/personalized-deep-research/tree/dejavu)
...
<CardGroup cols={2}>
  ...
  <Card title="YouTube Research with Deja Vu" icon="video" href="/cookbooks/companions/youtube-research">
