...
description: "Comprehensive reference of all API changes between Deja Vu v0.x and v1.0.0 Beta, organized by component and method."
icon: "code"
iconType: "solid"
---
...
This page documents all API changes between Deja Vu v0.x and v1.0.0 Beta, organized by component and method.
