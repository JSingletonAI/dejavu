...
Deja Vu provides a comprehensive REST API for integrating advanced memory capabilities into your applications. Create, search, update, and manage memories across users, agents, and custom entities with simple HTTP requests.

<Info>
**Quick start:** Get your API key from the <a href="https://app.dejavu.ai/dashboard/api-keys?utm_source=oss&utm_medium=api-reference" rel="nofollow">Deja Vu Dashboard</a> and make your first memory operation in minutes.
</Info>
...
Get started with Deja Vu API in three simple steps:
...
Get your API key from the <a href="https://app.dejavu.ai/dashboard/api-keys?utm_source=oss&utm_medium=api-reference" rel="nofollow">Deja Vu Dashboard</a>.
