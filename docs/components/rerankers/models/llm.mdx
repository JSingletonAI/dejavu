...
description: "Use any LLM as a flexible reranker in Deja Vu with custom prompts and domain-specific scoring logic."
---
...
Any LLM provider supported by Deja Vu can be used for reranking:
