---
title: "Databricks"
description: "Use Databricks Vector Search as a serverless vector store in Deja Vu with auto-updating indexes from Delta tables."
---
...
| `collection_name` | Vector search index name | `dejavu` |
