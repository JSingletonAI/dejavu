...
description: "Use Google Cloud Vertex AI Vector Search as a managed vector store in Deja Vu with endpoint and index configuration."
---


### Usage

To use Google Cloud Vertex AI Vector Search with `dejavu`, you need to configure the `vector_store` in your `dejavu` config:
