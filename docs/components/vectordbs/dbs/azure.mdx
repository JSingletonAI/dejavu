...
description: "Use Azure AI Search as a vector store in Deja Vu for managed vector search with service name and API key setup."
---
...
6. **Choose Role:**
    - Deja Vu requires the **Search Index Data Contributor** and **Search Service Contributor** role.
7. **Choose Member**
...
| `collection_name` | The name of the collection/index to store vectors | `dejavu` | Any valid index name |
