---
title: "Turbopuffer"
description: "Use Turbopuffer as a serverless vector database in Deja Vu for low-latency search at scale with native metadata filtering."
---
...
| --- | --- | --- |
| `collection_name` | Name of the namespace/collection | `dejavu` |
