---
title: Overview
description: "Overview of all supported vector databases in Deja Vu, including Qdrant, Chroma, PGVector, Pinecone, and more."
---

Deja Vu includes built-in support for various popular databases. Memory can utilize the database provided by the user, ensuring efficient use for specific needs.
