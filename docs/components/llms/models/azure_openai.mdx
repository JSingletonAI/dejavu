---
title: Azure OpenAI
description: "Configure Azure OpenAI as an LLM provider in Deja Vu with Azure Identity authentication and deployment settings."
---

<Note> Deja Vu Now Supports Azure OpenAI Models in TypeScript SDK </Note>
...
Below is a sample configuration for using Deja Vu with Azure OpenAI and Azure Identity:
