---
title: LangChain
description: "Use LangChain as an LLM provider in Deja Vu to integrate with various chat models through a unified interface."
---


Deja Vu supports LangChain as a provider to access a wide range of LLM models. LangChain is a framework for developing applications powered by language models, making it easy to integrate various LLM providers through a consistent interface.
