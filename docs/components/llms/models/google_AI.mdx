---
title: Google AI
description: "Configure Google Gemini as an LLM provider in Deja Vu using the google.genai SDK and GOOGLE_API_KEY variable."
---
...
> **Note:** As of the latest release, Deja Vu uses the new `google.genai` SDK instead of the deprecated `google.generativeai`. All message formatting and model interaction now use the updated `types` module from `google.genai`.
