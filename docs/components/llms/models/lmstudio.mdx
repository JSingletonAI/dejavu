---
title: LM Studio
description: "Configure LM Studio as an LLM provider in Deja Vu for running local language models via an OpenAI-compatible API."
---

To use LM Studio with Deja Vu, you'll need to have LM Studio running locally with its server enabled. LM Studio provides a way to run local LLMs with an OpenAI-compatible API.
...
You can also use LM Studio for both LLM and embedding to run Deja Vu entirely locally:
