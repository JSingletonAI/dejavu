...
description: "Reference for LLM configuration options in Deja Vu for Python and TypeScript, including value precedence rules."
---
...
Here's a general example of how to use the config with Deja Vu:
