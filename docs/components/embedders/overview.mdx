---
title: Overview
description: "Overview of all supported embedding model providers in Deja Vu, including OpenAI, Azure, Ollama, and more."
---

Deja Vu offers support for various embedding models, allowing users to choose the one that best suits their needs.
