---
title: "LM Studio"
description: "Configure LM Studio as an embedding provider in Deja Vu for local embedding generation with models like nomic-embed-text."
---
You can use embedding models from LM Studio to run Deja Vu locally.
