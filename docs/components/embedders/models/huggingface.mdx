---
title: Hugging Face
description: "Configure Hugging Face as an embedding provider in Deja Vu for local embedding generation with open-source models."
---

You can use embedding models from Huggingface to run Deja Vu locally.
