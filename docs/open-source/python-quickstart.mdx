...
description: "Install the Deja Vu Python SDK, configure your environment, and store your first memory in under five minutes."
icon: "snake"
---

Get started with Deja Vu's Python SDK in under 5 minutes. This guide shows you how to install Deja Vu and store your first memory.
...
- SQLite history at `~/.dejavu/history.db`
...
<Card title="Configuration" icon="sliders" href="/open-source/configuration">
  Customize Deja Vu with different LLMs, vector stores, and embedders for production use
</Card>
...
- **[OpenAI Compatibility](/open-source/features/openai_compatibility)** - Use Deja Vu with OpenAI-compatible chat completions
- **[Contributing Guide](/contributing/development)** - Learn how to contribute to Deja Vu
- **[Examples](/cookbooks/companions/local-companion-ollama)** - See Deja Vu in action with Ollama and other integrations
